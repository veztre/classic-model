            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('products.update', $product) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="productCode" class="form-label">Product Code (Read-only)</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('productLine') is-invalid @enderror"
                                        ...
                                        <option value="{{ $line->productLine }}"
                                            {{ old('productLine', $product->productLine) == $line->productLine ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('productScale') is-invalid @enderror"
                                        id="productScale" name="productScale"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0"
                                        ...
                                        name="buyPrice" value="{{ old('buyPrice', $product->buyPrice) }}">
                                    @error('buyPrice')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
