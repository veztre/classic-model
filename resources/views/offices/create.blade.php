                    ...
                    <div class="card-body">
                        <form action="{{ route('offices.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('officeCode') is-invalid @enderror"
                                    id="officeCode" name="officeCode" value="{{ old('officeCode') }}" required>
                                @error('officeCode')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('addressLine1') is-invalid @enderror"
                                    id="addressLine1" name="addressLine1" value="{{ old('addressLine1') }}" required>
                                @error('addressLine1')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
