...
<head>
    ...
    <title>Classic Models - @yield('title', 'Dashboard')</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('employee.dashboard') }}">My Dashboard</a>
                        </li>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>&copy; 2025 Classic Models. All rights reserved.</p>
                </div>
