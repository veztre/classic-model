...
<div class="container">
    <div class="row mb-4">
        <div class="col-md-8">
            <h1>Edit Customer: {{ $customer->customerName }}</h1>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('customers.update', $customer) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="customerNumber" class="form-label">Customer Number (Read-only)</label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('contactFirstName', $customer->contactFirstName) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('contactLastName', $customer->contactLastName) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" min="0"
                                ...
                                name="creditLimit" value="{{ old('creditLimit', $customer->creditLimit) }}">
                            @error('creditLimit')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
